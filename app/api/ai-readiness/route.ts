...
// Firecrawl client is initialized inside the POST function to avoid build-time errors
...
export async function POST(request: NextRequest) {
  // Initialize Firecrawl client inside the function to avoid build-time errors
